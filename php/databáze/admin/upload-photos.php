    ...
    if(isset($_POST["submit"]) && isset($_FILES["image"])){
        ...
        if ($error === 0){
            if ($image_size > 9000000){ 
                ...
                Url::redirectUrl("/php/databáze/errors/error-page.php?error_text=Váš soubor je příliš veliký");
                ...
                if(in_array($image_extension_lower_case, $allowed_extensions)){
                    ...
                    Url::redirectUrl("/php/databáze/errors/error-page.php?error_text=typ vašeho souboru není povolen");
                }
            }
        } else {
            Url::redirectUrl("/php/databáze/errors/error-page.php?error_text=Nahrání obrázku se bohužel nepodařilo");
        }
    }
